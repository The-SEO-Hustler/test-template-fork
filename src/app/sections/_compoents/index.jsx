...
import FeatureSection1 from "@/components/servicesSection/services1";
import FeatureSection2 from "@/components/servicesSection/services2";
import FeatureSection3 from "@/components/servicesSection/services3";
import FeatureSection4 from "@/components/servicesSection/services4";
...
import Cases5 from "@/components/caseStudies/cases5";
    ...
    <div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Hero1 data={sampleData.hero} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Hero template: 2</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Hero2 data={sampleData.hero} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Hero template: 3</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection3 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection4 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection5 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection6 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection7 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <HeroSection8 data={sampleData.hero} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FeatureSection1 data={sampleData.services} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Features template: 2</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FeatureSection2 data={sampleData.services} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Features template: 3</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FeatureSection3 data={sampleData.services} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Features template: 4</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FeatureSection4 data={sampleData.services} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Faq1 data={sampleData.faq} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Faq template: 2</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Faq2 data={sampleData.faq} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Cases1 data={sampleData.cases} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Cases template: 2</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Cases2 data={sampleData.cases} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Cases template: 3</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Cases3 data={sampleData.cases} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Cases template: 4</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Cases4 data={sampleData.cases} />
        </div>
      </div>

      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Cases template: 5</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <Cases5 data={sampleData.cases} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <TestimonialsSection1 data={sampleData.testimonialsSection} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <TestimonialsSection2 data={sampleData.testimonialsSection} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <CtaSection1 data={sampleData.cta} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <CtaSection2 data={sampleData.cta} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <CtaSection3 data={sampleData.cta} />
        </div>
      </div>

      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Portfolio template: 1</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <PortifolioSection1 data={sampleData.portfolio} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Portfolio template: 2</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <PortifolioSection2 data={sampleData.portfolio} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Portfolio template: 3</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <PortifolioSection3 data={sampleData.portfolio} />
        </div>
      </div>
      <div className="my-6 relative max-w-[1300px] mx-auto">
        <p className="mb-2">Portfolio template: 4</p>
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <PortifolioSection4 data={sampleData.portfolio} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FooterBlock1 data={sampleData.footer} />
        </div>
      </div>
      ...
      <div className="my-6 relative max-w-[1300px] mx-auto">
        ...
        <div className="relative border-[10px] min-h-28 flex justify-center items-center border-gray-500 rounded-lg">
          <FooterBlock2 data={sampleData.footer} />
        </div>
      </div>
    </div>
  );
